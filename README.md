...
## Pull Request
Предложение влить текущую ветку в основную. Создается в интерфейсе github. Происходит после ревью кода старшими сотрудниками
...
2. Замержить их в свою рабочую ветку
3. Запушить ветку на удаленный репозиторий
